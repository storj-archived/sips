...
There is currently a "trusted keys" configuration for each farmer that defines which renters to accept contracts, this configuration can be extended to include a renter URL to use notify changes to a farmers contact data.

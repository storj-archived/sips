...
The renter will have a database of contacts and use the reputation algorithm described above to pick contacts, the renter will then send a `ALLOC` message with the format *(example)*:

...
Farmers can later update their contact details by sending an HTTP PATCH request to `/contacts/<node_id>` with the fields that should be updated, these requests should also include signature headers:
```
{
  "address": "2001:0db8:0000:0042:0000:8a2e:0370:7334",
  "port": 4006,
